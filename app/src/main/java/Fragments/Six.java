...
public class Six extends Fragment implements View.OnClickListener {
    ...
    Button B1,B2,B3,B4,B5,B6,Click;
    PlainDialog dialog;
    ValueHolder holder;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        Click=v.findViewById(R.id.clicksix);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.TC:
                ...
                break;
            case R.id.clicksix:
                CheckerClass checkerClass=new CheckerClass(3,holder);
                digit.setText(checkerClass.getTextView1());
                tolerance.setText(checkerClass.getTextView2());
                tempcoefficient.setText(checkerClass.getTextView3());
